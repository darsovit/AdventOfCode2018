...
class roomMap:
    ...
    def countRoomsWithMoreDoorsThan( self, value ):
        roomPosWithManyDoors = []
        for pos in self.field:
            if self.field[pos].getDistance() >= value:
                roomPosWithManyDoors += [ pos ]
        return len(roomPosWithManyDoors)
...
print(myMap.countRoomsWithMoreDoorsThan(1000))