...
def findLongestMinuteForGuard( guardDuties ):
    ...
    for minute in minuteCounts:
        if not highestMinuteCount:
            ...
            highestMinuteAsleep = minute
            highestMinuteCount = minuteCounts[minute]
    return ( highestMinuteAsleep, highestMinuteCount )
...
highestMinuteCount = 0
highestMinuteAsleep = None
highestMinuteCountGuardId = None
for guardId in guardDuties:
    ( thisGuardMinuteAsleep, thisGuardMinuteCount ) = findLongestMinuteForGuard( guardDuties[guardId] )
    if highestMinuteCount == 0:
        highestMinuteCount = thisGuardMinuteCount
        highestMinuteAsleep = thisGuardMinuteAsleep
        highestMinuteGuardId = guardId
    elif thisGuardMinuteCount > highestMinuteCount:
        highestMinuteCount = thisGuardMinuteCount
        highestMinuteAsleep = thisGuardMinuteAsleep
        highestMinuteGuardId = guardId

print( highestMinuteCount, highestMinuteAsleep, highestMinuteGuardId, highestMinuteAsleep * highestMinuteGuardId )